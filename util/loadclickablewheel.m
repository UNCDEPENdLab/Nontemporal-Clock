if full_wheel == 0
    ...
    Events = newevent_command(Events,clickwheeltime,command,'clear_no');
    command =   'Screen(''DrawDots'', Parameters.window, colorWheelLocations6, 10, selected_segment'', [], 1);';
    Events = newevent_command(Events,clickwheeltime,command,'clear_no');
elseif full_wheel == 1
    ...
    Events = newevent_command(Events,clickwheeltime,command,'clear_no');
    command =   'Screen(''DrawDots'', Parameters.window, colorWheelLocations4, 10, fullcolormatrix'', [], 1);';
    Events = newevent_command(Events,clickwheeltime,command,'clear_no');
    command =   'Screen(''DrawDots'', Parameters.window, colorWheelLocations5, 10, fullcolormatrix'', [], 1);';
    Events = newevent_command(Events,clickwheeltime,command,'clear_no');
    command =   'Screen(''DrawDots'', Parameters.window, colorWheelLocations6, 10, fullcolormatrix'', [], 1);';
    Events = newevent_command(Events,clickwheeltime,command,'clear_no');
elseif full_wheel == -1
    ...
    Events = newevent_command(Events,clickwheeltime,command,'clear_no');
    command =   'Screen(''DrawDots'', Parameters.window, colorWheelLocations4, 10, basecolormatrix'', [], 1);';
    Events = newevent_command(Events,clickwheeltime,command,'clear_no');
    command =   'Screen(''DrawDots'', Parameters.window, colorWheelLocations5, 10, basecolormatrix'', [], 1);';
    Events = newevent_command(Events,clickwheeltime,command,'clear_no');
    command =   'Screen(''DrawDots'', Parameters.window, colorWheelLocations6, 10, basecolormatrix'', [], 1);';
    Events = newevent_command(Events,clickwheeltime,command,'clear_no');
else
