...
load('blockvars')
points_wheel = 0;
type = 3; %paradigm type: 1 = probabilities random, 2 = uneven, 3 = gold mine
...
Events = newevent_command(Events,reward_time,showdotscommand2,'clear_no');
                    ...
                    Events = newevent_show_stimulus(Events,reward,1,locx,rewardtext_locy+y_offset-50,reward_time,'screenshot_no','clear_no'); %reward text
                else
                    %Loads color Wheel
                    command =   'load(''selected_segment'');';
...
Events = newevent_command(Events,reward_time,showdotscommand2,'clear_no');
                    ...
                    Events = newevent_show_stimulus(Events,reward,3,locx,rewardtext_locy+y_offset-50,reward_time,'screenshot_no','clear_no'); %reward text
                end
...
Events = newevent_command(Events,reward_time,showdotscommand2,'clear_no');
            ...
            Events = newevent_show_stimulus(Events,reward,2,locx,rewardtext_locy+y_offset-50,instruction_display_time,'screenshot_no','clear_no'); %no reward
            %Display red X mark
...
%Cartesian Conversion
pointsWheelLocations2 = [cosd(1:359).*pointsWheelRadius2 + Parameters.centerx; ...
    sind(1:359).*pointsWheelRadius2 + Parameters.centery];%Points Wheel 1 (Inner)
pointsWheelRadius1 = colorWheelRadius1 + 20; %radius of color wheel
%Cartesian Conversion
pointsWheelLocations1 = [cosd(1:359).*pointsWheelRadius1 + Parameters.centerx; ...
    sind(1:359).*pointsWheelRadius1 + Parameters.centery];
...
Events = newevent_command(Events,color_wheel_time,showdotscommand2,'clear_no');
            ...
            Events = newevent_show_stimulus(Events,30,2,locx,locy-350,color_wheel_time,'screenshot_no','clear_no');
