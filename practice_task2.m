...
if strcmp(Modeflag,'InitializeBlock')
    ...
    ins = 31;
    stimstruct = CreateStimStruct('text');
    stimstruct.stimuli = {'You and the computer will be playing a game together.','The goal of the game is to win as many nickels as possible,','which will be exchanged for real life money', ...
        'at the end of the game. On each trial, you','will see a blue, segmented wheel.','Your task is to find the segment that awards nickels most frequently.','After clicking on a segment, you will see whether' ...
        'you gained a nickel or not.','To help you get an idea of how everything works,','we''ve provided a training section before you begin.','Press Spacebar to continue to training.'};
    %     stimstruct.stimuli = {'On each trial, you will see a blue, segmented wheel.','Your task is to click on different parts of this wheel in','order to figure out which section is more likely to award you points.', ...
    %         'However, sometimes the computer will','only give you one segment choice.','Press any button once you''re ready to begin.'};
    stimstruct.stimsize = 20;
...
%     end
    ...
    if bot_mode && ~turn_bot_off && Trial ~= 1
    ...
    if Trial == 1 && Blocknum == 1
        ...
        if ~test_mode
            ...
            Events = newevent_show_stimulus(Events,ins,1,locx,locy-375,instruction_display_time,'screenshot_no','clear_yes');
            Events = newevent_show_stimulus(Events,ins,2,locx,locy-300,instruction_display_time,'screenshot_no','clear_no');
            Events = newevent_show_stimulus(Events,ins,3,locx,locy-225,instruction_display_time,'screenshot_no','clear_no');
            Events = newevent_show_stimulus(Events,ins,4,locx,locy-150,instruction_display_time,'screenshot_no','clear_no');
            Events = newevent_show_stimulus(Events,ins,5,locx,locy-75,instruction_display_time,'screenshot_no','clear_no');
            Events = newevent_show_stimulus(Events,ins,6,locx,locy,instruction_display_time,'screenshot_no','clear_no');
            Events = newevent_show_stimulus(Events,ins,7,locx,locy+75,instruction_display_time,'screenshot_no','clear_no');
            Events = newevent_show_stimulus(Events,ins,8,locx,locy+150,instruction_display_time,'screenshot_no','clear_no');
            Events = newevent_show_stimulus(Events,ins,9,locx,locy+225,instruction_display_time,'screenshot_no','clear_no');
            Events = newevent_show_stimulus(Events,ins,10,locx,locy+300,instruction_display_time,'screenshot_no','clear_no');
            ...
            wheelinstime = instruction_display_time + .01;
            reward_time = wheelinstime + .01;
